...
rm -rf /Users/TienTong/Documents/dcm2bids/BIDS/tmp_dcm2bids
...
$script_dir/xnat_download.py \
  ...
  --download_dir /Users/TienTong/Documents/dcm2bids/DICOM

###############################################################################
################### STEP 2: CONVERT TO NIFTY AND PUT IN BIDS ##################
###############################################################################

new_download=($(ls -td /Users/TienTong/Documents/dcm2bids/DICOM/* | \
                head -${num_subject}))
for i in ${!new_download[@]} ; do
    subject_id=`echo ${new_download[$i]} | awk -F "_" '{print $NF}'`
    mv ${new_download[$i]} /Users/TienTong/Documents/dcm2bids/DICOM/${subject_id}

    ################### STEP 2.1a: CONVERT TO NIFTY AND PUT IN BIDS ############
    echo "Start doing BIDS conversion for subject" ${subject_id}
    dcm2bids \
      -d /Users/TienTong/Documents/dcm2bids/DICOM/${subject_id}/*/scans \
      -p ${subject_id} \
      -c /Users/TienTong/Documents/dcm2bids/dcm2bids_config.json \
      -o /Users/TienTong/Documents/dcm2bids/BIDS \
    ...
    subject_func=/Users/TienTong/Documents/dcm2bids/BIDS/sub-${subject_id}/func
    ...
    $script_dir/modify_json.py \
      --subject ${subject_id} \
      --bids_path /Users/TienTong/Documents/dcm2bids/BIDS
